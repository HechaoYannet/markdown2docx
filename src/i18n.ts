...
export const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    typographySummary: "导出字号设置（可折叠）",
    typographyHint: "单位为 Word 半磅值，例如 24=12pt。默认值会自动保存到本地。",
    bodySizeLabel: "正文",
    heading1SizeLabel: "标题 H1",
    heading2SizeLabel: "标题 H2",
    heading3SizeLabel: "标题 H3",
    heading4SizeLabel: "标题 H4",
    heading5SizeLabel: "标题 H5",
    heading6SizeLabel: "标题 H6",
    resetTypography: "恢复默认字号",
    typographyResetDone: "已恢复默认字号设置。",
  ...
  en: {
    ...
    typographySummary: "Export Size Settings (Collapsible)",
    typographyHint: "Values use Word half-points, e.g. 24 = 12pt. Changes are saved locally by default.",
    bodySizeLabel: "Body",
    heading1SizeLabel: "Heading H1",
    heading2SizeLabel: "Heading H2",
    heading3SizeLabel: "Heading H3",
    heading4SizeLabel: "Heading H4",
    heading5SizeLabel: "Heading H5",
    heading6SizeLabel: "Heading H6",
    resetTypography: "Restore Default Sizes",
    typographyResetDone: "Typography settings restored to defaults.",
